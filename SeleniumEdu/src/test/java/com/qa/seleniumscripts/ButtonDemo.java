...
public class ButtonDemo {
	...
	boolean enable2 = driver.findElement(By.xpath("//input[@type='email']")).isEnabled();
	System.out.println("Is Enabled: "+enable2);
	Thread.sleep(2000);
	
	driver.findElement(By.xpath("//input[@type='email']")).sendKeys("Yashwanth09876");
