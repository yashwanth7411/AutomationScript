...
//		map2.put("pwd", "Third Password");
			...
			List<HashMap<String, String>> data = getJsonDataToMap (System.getProperty("user.dir")+"//src//test//java//automation_json//data//PurchaseOrder.json");
